...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
/*The nested function can access the variable internal because the variable is within the lexical scope
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
    ...
    zooAnimals.map(function(zooAnimals) {
      return lowerCase.push(zooAnimals.animal_name.toLowerCase());
    })
    return lowerCase;
  };
